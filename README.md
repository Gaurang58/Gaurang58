...
**Focus:** Python, automation, data processing and workflow design

[View repository](https://github.com/Gaurang58/assisted-job-bot)
...
**Focus:** Node.js, Express.js, REST APIs and databases

[View repository](https://github.com/Gaurang58/AirbnbWebapi)
...
**Focus:** JavaScript, Node.js, Jest, unit testing and TDD

[View repository](https://github.com/Gaurang58/dwp-cinema-tickets-node)
...
**Focus:** Frontend development, responsive design and project presentation

[View live website](https://gaurang-portfolio-nine.vercel.app/) ·
[View repository](https://github.com/Gaurang58/gaurang-portfolio)
...
* Supported backend application changes, testing, configuration and maintenance within an Agile delivery environment.
* Validated REST API responses, application behaviour, technical requirements and data flows.
* Assisted with defect investigation by reviewing logs, API responses and environment-related changes.
...
* Supported backend development for a property-booking platform using Node.js, Express.js and REST APIs.
* Built and updated API endpoints for customer, booking and service-related workflows.
* Worked with SQL and NoSQL databases to store, retrieve, update and validate application data.
* Practised unit and integration testing using Jest and test-driven development principles.
* Used application logs and Grafana dashboards to investigate errors and understand system behaviour.
